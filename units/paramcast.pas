...
type
  TFParamCast = class(TForm)
    ...
    cxButtonBY: TcxButton;
    EtJgSpinEdit: TSpinEdit;
    procedure BtOkClick(Sender: TObject);
    procedure FormShow(Sender: TObject);
    procedure FormCreate(Sender: TObject);
    procedure cxButtonBYClick(Sender: TObject);
...
procedure TFParamCast.BtOkClick(Sender: TObject);
begin
...
procedure TFParamCast.FormShow(Sender: TObject);
var
  i:integer;
begin
...
procedure TFParamCast.FormCreate(Sender: TObject);
begin
  TrForm(Self);
...
procedure TFParamCast.cxButtonBYClick(Sender: TObject);
begin
  EtStimulus_Color.ItemIndex := 2;
  EtStimulus_Size.ItemIndex := 4;
  EtBackground_Color.ItemIndex := 1;
end;

procedure TFParamCast.EtDelay_ModePropertiesChange(Sender: TObject);
begin
  if EtDelay_Mode.ItemIndex=1 then
  begin
    EtJgSpinEdit.Visible := True;
